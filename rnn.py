...
for i in range(60, 1258):
    X_train.append(training_set_scaled[i-60:i, 0])  # X_train - list of Numpy arrays
    y_train.append(training_set_scaled[i, 0])
X_train, y_train = np.array(X_train), np.array(y_train)  # convert list to Numpy array


# Reshaping
X_train = np.reshape(X_train, (X_train.shape[0], X_train.shape[1], 1)) # 3rd dimension - the number of predictors/indicators
...
from keras.layers import Dropout     # simple way ro prevent overfitting
